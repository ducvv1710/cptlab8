...
router.post('/edit/:name', function(req, res) {
  var prod_name = req.params.name;
  const update_query = {
      text: 'UPDATE product SET id=$1, shop_name=$2, product_name=$3, price=$4 ,amount=$5 WHERE id=$6',
      values: [req.body.id, req.body.shop_name, req.body.product_name, req.body.price, req.body.amount,prod_name]
  };
...
router.post('/insert', function(req, res) {
  const insert_query = {
      ...
      values: [req.body.id, req.body.shop_name, req.body.product_name, req.body.price, req.body.amount]
  };
...
router.get('/register', function(req, res) {
  ...
  router.post('/register', function(req, res) {
    const register_query = {
        ...
        values: [req.body.account_name, req.body.account_password]
    };
